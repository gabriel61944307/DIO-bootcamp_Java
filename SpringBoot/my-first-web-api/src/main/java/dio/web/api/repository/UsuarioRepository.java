...
public class UsuarioRepository {
	...
	public List<Usuario> findAll(){
		...
		usuarios.add(new Usuario("gabriel", "senha"));
	...
	public Usuario findById(Integer id) {
		...
		return new Usuario("gabriel", "senha");
	}
	
	public Usuario findByUsername(String username) {
		System.out.println(String.format("FIND/id - Recebendo o nome: %s para localizar um usuário", username));
		return new Usuario("gabriel", "senha");
	}
}
